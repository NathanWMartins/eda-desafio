...
import (
	...
	"github.com/NathanWMartins/fc-ms-balance/internal/database"
	getaccount "github.com/NathanWMartins/fc-ms-balance/internal/usecase/get_account"
	replicateaccount "github.com/NathanWMartins/fc-ms-balance/internal/usecase/replicate_account"
	"github.com/NathanWMartins/fc-ms-balance/internal/web"
	server "github.com/NathanWMartins/fc-ms-balance/internal/web/webserver"
	"github.com/NathanWMartins/fc-ms-balance/pkg/kafka"
